...
static void draw_ground2() {
    ...
    for (int i =0; i<draw_flg+1; i++) {
        glVertex2d(gr_xpos + 12*i, (ysize - gr_ypos) - (ysize / 12)+array_right[i]); // KOKO! (BUFFALO = 12)(CCD = 15)
        glVertex2d(gr_xpos + 12*(i+1), (ysize - gr_ypos) - (ysize / 12)+array_right[i+1]);
        glVertex2d(gr_xpos + 12*(i+1), 0);
        glVertex2d(gr_xpos + 12*i, 0);
        
        glVertex2d(gr_xpos - 12*i, (ysize - gr_ypos) - (ysize / 12)+array_left[i]); // KOKO! (BUFFALO = 12)(CCD = 15)
        glVertex2d(gr_xpos - 12*(i+1), (ysize - gr_ypos) - (ysize / 12)+array_left[i+1]);
        glVertex2d(gr_xpos - 12*(i+1), 0);
        glVertex2d(gr_xpos - 12*i, 0);
    }
